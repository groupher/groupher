...
import * as AnalysisSchema from '../unit/DashboardThread/Analysis/WebOverview/schema'
import * as ThemeSchema from '../unit/DashboardThread/Appearance/Theme/schema'
import WallpaperSchema from '../unit/DashboardThread/Appearance/Wallpaper/schema'
import ImportSchema from '../unit/DashboardThread/CMS/Docs/Import/schema'
import DashboardAdminsSchema from '../unit/DashboardThread/schema/admins'
import DashboardAppearanceSchema from '../unit/DashboardThread/schema/appearance'
...
import DashboardIntegrationsSchema from '../unit/DashboardThread/schema/integrations'
import DashboardSettingsSchema from '../unit/DashboardThread/schema/settings'
import DashboardShellSchema from '../unit/DashboardThread/schema/shell'
