...
export default function useSalon({ width, labelPlacement, hideLabel, ...spacing }: TProps) {
  ...
  return {
    wrapper: cn(
      'group/range-input w-full max-w-3xl gap-3',
    ...
    valueLabel: cn(
      ...
      !hideLabel &&
        !hasLeftLabel &&
        'opacity-0 translate-y-1 pointer-events-none transition-all delay-1000 duration-200 ease-out group-hover/range-input:delay-200 group-hover/range-input:opacity-100 group-hover/range-input:translate-y-0 group-hover/range-input:pointer-events-auto group-focus-within/range-input:delay-0 group-focus-within/range-input:opacity-100 group-focus-within/range-input:translate-y-0 group-focus-within/range-input:pointer-events-auto',
    ),
    ...
    indicator: cn(
      'h-3 w-0.5 rounded-lg opacity-50 origin-center scale-y-50 transition-[opacity,transform] delay-1000 duration-200 ease-out group-hover/range-input:delay-100 group-hover/range-input:scale-y-100 group-focus-within/range-input:delay-0 group-focus-within/range-input:scale-y-100 group-hover/indicator:opacity-100',
      bg('digest'),
    ),
    dot: 'absolute top-1/2 w-0.5 h-2 circle -translate-x-1/2 -translate-y-1/2 origin-center scale-y-50 transition-transform delay-1000 duration-200 ease-out group-smoky-0 group-hover/range-input:delay-100 group-hover/range-input:scale-y-100 group-focus-within/range-input:delay-0 group-focus-within/range-input:scale-y-100',
