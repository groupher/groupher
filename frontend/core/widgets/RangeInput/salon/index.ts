...
export default function useSalon({ width, ...spacing }: TProps) {
  ...
  return {
    ...
    valueLabel:
      'row-center justify-start gap-1 text-sm leading-none opacity-0 translate-y-1 pointer-events-none transition-all delay-1000 duration-200 ease-out group-hover:delay-0 group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto group-focus-within:delay-0 group-focus-within:opacity-100 group-focus-within:translate-y-0 group-focus-within:pointer-events-auto',
    ...
    trackPart: cn(
      'absolute top-0 h-4 rounded-sm border origin-center scale-y-50 transition-transform delay-1000 duration-200 ease-out group-hover:delay-0 group-hover:scale-y-100 group-focus-within:delay-0 group-focus-within:scale-y-100',
    ),
    ...
    indicator: cn(
      'h-3 w-0.5 rounded-lg opacity-50 origin-center scale-y-50 transition-[opacity,transform] delay-1000 duration-200 ease-out group-hover:delay-0 group-hover:scale-y-100 group-focus-within:delay-0 group-focus-within:scale-y-100 group-hover/indicator:opacity-100',
      bg('digest'),
    ),
    dot: 'absolute top-1/2 w-0.5 h-2 circle -translate-x-1/2 -translate-y-1/2 origin-center scale-y-50 transition-transform delay-1000 duration-200 ease-out group-smoky-0 group-hover:delay-0 group-hover:scale-y-100 group-focus-within:delay-0 group-focus-within:scale-y-100',
