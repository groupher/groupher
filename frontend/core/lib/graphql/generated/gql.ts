...
type Documents = {
  ...
  '\n  mutation UpdatePostFromMenu($article: ArticlePathInput!, $expectedVersion: Int!, $title: String, $communityTags: [ID]) {\n    updatePost(article: $article, expectedVersion: $expectedVersion, title: $title, communityTags: $communityTags) {\n      innerId\n      title\n      communityTags {\n        ...ArticleMenuTagFields\n      }\n    }\n  }\n': typeof types.UpdatePostFromMenuDocument
