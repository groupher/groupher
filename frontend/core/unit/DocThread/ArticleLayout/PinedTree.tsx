...
import useSalon, { cn } from './salon/pined_tree'
...
export default function PinedTree() {
  ...
  return (
    <div className={s.wrapper}>
      <button type='button' className={s.item} onClick={() => back2Layout()}>
      ...
      <button type='button' className={s.item} onClick={() => gotoFAQDetailLayout()}>
        <div className={s.iconBox}>
