    ...
    <div className={s.wrapper}>
      <div className={s.left}>
        <div className={s.head}>
          ...
          <div className={s.title}>{t('dsb.appearance.primary_color.label')}</div>
        </div>
      ...
      <div className={s.right}>
        <div className={cn(s.head, s.subHead)}>
          ...
          <div className={s.title}>{t('dsb.appearance.accent_color.title')}</div>
        </div>
        <p className={s.desc}>{t('dsb.appearance.accent_color.desc')}</p>
      </div>
    </div>
  )
}
