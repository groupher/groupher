export default function useSalon() {
  return {
    ...
    list: 'column gap-y-2',
    item: 'row-center min-h-14 gap-x-3 rounded-sm border border-divider bg-base px-3 py-2',
    ...
    restoreButton:
      'row-center h-8 shrink-0 gap-x-1.5 rounded-sm px-2 text-xs text-title transition-colors hover:bg-hover disabled:cursor-not-allowed disabled:opacity-50',
