...
export default function useSalon() {
  ...
  return {
    ...
    row: cn('grid w-full min-w-0 grid-cols-[0.75rem_minmax(0,1fr)] gap-0.5 py-0.5', fg('digest')),
    ...
    marker: cn('select-none text-center font-mono bold-sm leading-5', fg('hint')),
    text: 'min-w-0 whitespace-pre-wrap break-words',
