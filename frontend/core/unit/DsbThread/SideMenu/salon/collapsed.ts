...
export default function useSalon() {
  ...
  return {
    wrapper: cn(
      'relative column h-full w-14 min-w-14 items-start cursor-pointer opacity-40 transition-opacity duration-300 delay-1000 hover:duration-100 hover:delay-0 hover:opacity-100',
      fg('digest'),
    ),
    menu: 'column items-center w-14',
    group: cn('column items-center gap-1.5 w-full pb-2 border-b last:border-b-0', br('divider')),
    item: cn(
