...
export default () => {
  ...
  return {
    communityTitle: cn('text-sm bold-sm', fg('text.title')),
    //
    ...
    //
    pending: cn('bold-sm text-xs mt-0.5', fg('text.digest')),
    pendingBlocked: rainbow(COLOR_NAME.RED, 'fg'),
    //
    dateItem: cn('row-center text-xs', fg('text.digest')),
    dateItemWarn: rainbow(COLOR_NAME.RED, 'fg'),
    //
    pulseIcon: cn('size-2.5 opacity-80 mr-1.5', fill('text.digest')),
  }
}
