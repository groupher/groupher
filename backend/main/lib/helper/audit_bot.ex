defmodule Helper.AuditBot do
  ...
  @doc "Runs `analysis` through the public `AuditBot` boundary."
  ...
  @doc "Runs `analysis_wrong` through the public `AuditBot` boundary."
  ...
  @doc "Runs `test` through the public `AuditBot` boundary."
  def test do
    text = """
