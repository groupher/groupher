defmodule GroupherServer.CMS.DocTree.Write do
  ...
  ## Examples
      ...
      iex> Write.create_page(community, %{parent_node_id: group.node_id, title: "Intro"}, user)
      {:ok, %{node: %{type: :page}}}
  """
  ...
  ## Examples
      ...
      iex> Write.create_link(community, %{parent_node_id: group.node_id, href: "https://example.com"})
      {:ok, %{node: %{type: :link}}}
  """
  ...
  defp duplicate_nodes(community, branch, %DocTreeNode{type: :group} = root, args) do
    nodes = Read.tree_nodes!(community, [branch_id: branch.id], CMS.Const.stage(:draft))
  ...
  ## Examples
      ...
      iex> Write.move_node(community, page.node_id, %{target_parent_node_id: group.node_id, target_index: 0})
      {:ok, %{affected_nodes: [_]}}
  """
