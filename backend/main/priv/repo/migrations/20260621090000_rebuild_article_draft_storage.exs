defmodule GroupherServer.Repo.Migrations.RebuildArticleDraftStorage do
  ...
  def up do
    ...
    execute(
      "ALTER TABLE cms.article_snapshots DROP CONSTRAINT IF EXISTS article_snapshots_target_check;"
    )

    create_if_not_exists(index(:article_snapshots, [:thread, :article_draft_id], prefix: @prefix))
    ...
    execute("""
    ALTER TABLE cms.article_snapshots
