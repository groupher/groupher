defmodule GroupherServer.Test.Mutation.Flags.ChangelogFlag do
  ...
  setup do
    ...
    {:ok, changelog2} = CMS.Articles.create(community, :changelog, mock_attrs(:changelog), user)
    {:ok, changelog3} = CMS.Articles.create(community, :changelog, mock_attrs(:changelog), user)
