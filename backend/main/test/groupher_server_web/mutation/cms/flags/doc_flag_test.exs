defmodule GroupherServer.Test.Mutation.Flags.DocFlag do
  ...
  describe "[mutation doc flag curd]" do
    test "auth user can markDelete doc", ~m(community doc)a do
      ...
      updated =
        rule_conn |> gq_mutation(S.Article.m(:mark_delete_article, :doc), variables)
    ...
    test "unauth user markDelete doc fails",
      ...
      schema = S.Article.m(:mark_delete_article, :doc)
    ...
    test "auth user can undo markDelete doc", ~m(community doc)a do
      ...
      updated =
        rule_conn |> gq_mutation(S.Article.m(:undo_mark_delete_article, :doc), variables)
    ...
    test "unauth user undo markDelete doc fails",
      ...
      schema = S.Article.m(:undo_mark_delete_article, :doc)
    ...
    test "auth user can batch mark delete docs",
      ...
      updated = rule_conn |> gq_mutation(S.Article.m(:batch_mark_delete_article, :doc), variables)
    ...
    test "auth user can batch undo mark delete docs",
      ...
      updated =
        rule_conn |> gq_mutation(S.Article.m(:batch_undo_mark_delete_article, :doc), variables)
    ...
    test "auth user can pin doc", ~m(community doc)a do
      ...
      updated = rule_conn |> gq_mutation(S.Article.m(:pin_article, :doc), variables)
    ...
    test "unauth user pin doc fails", ~m(user_conn guest_conn community doc)a do
      ...
      assert user_conn
             |> mutation_error?(S.Article.m(:pin_article, :doc), variables, ecode(:passport))

      assert guest_conn
             |> mutation_error?(
               S.Article.m(:pin_article, :doc),
               variables,
               ecode(:account_login)
             )
    ...
    test "auth user can undo pin doc", ~m(community doc)a do
      ...
      updated = rule_conn |> gq_mutation(S.Article.m(:undo_pin_article, :doc), variables)
    ...
    test "unauth user undo pin doc fails", ~m(user_conn guest_conn community doc)a do
      ...
      assert user_conn
             |> mutation_error?(
               S.Article.m(:undo_pin_article, :doc),
               variables,
               ecode(:passport)
             )
