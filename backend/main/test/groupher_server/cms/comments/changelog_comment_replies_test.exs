defmodule GroupherServer.Test.CMS.Comments.ChangelogCommentReplies do
  @moduledoc false
  ...
  alias CMS.Model.{Comment, Changelog}
  ...
  describe "[basic article comment replies]" do
    @tag :wip
    test "exist comment can be reply", ~m(community changelog user user2)a do
      {:ok, parent_comment} =
