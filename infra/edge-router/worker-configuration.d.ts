/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 711785c2039d72c8cde0238f642e45b9)
// Runtime types generated with workerd@1.20260730.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
  CF_VERSION_METADATA: WorkerVersionMetadata
  API_SITE: 'https://api.groupher.com'
  PRESS_SITE: 'https://press.groupher.com'
  CUSTOM_DOMAIN_COMMUNITIES: '{}'
  NODE_ENV: 'production'
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'API_SITE' | 'PRESS_SITE' | 'CUSTOM_DOMAIN_COMMUNITIES' | 'NODE_ENV'>
  > {}
}
